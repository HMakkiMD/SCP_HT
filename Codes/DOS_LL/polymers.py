...
POLYMER_DIC={'AIG(b12_2_8x2)_BT':	 ['AIG','BT'],
 ...
 'BN_DPP(b12_2_8x2)_BN_TT':	 ['BN', 'DPP', 'BN', 'TT'],
 'BN_DPP(b12_2_8x2)_BN_T_T':	 ['BN', 'DPP', 'BN', 'T', 'T'],
 'BN_DPP(b12_2_8x2)_BN_TFF':	 ['BN', 'DPP', 'BN','TFF'],
 'BNT_DPP(b12_2_8x2)_BNT_TFF':	 ['BNT', 'DPP', 'BNT', 'TFF'],
 'CPDT(a16x2)_BFF':	 ['CPDT','BFF'],
 'CPDT(b6_2_2x2)_BT':	 ['CPDT','BT'],
 'DPP(b12_2_8x2)_FU_FU_FU':	['DPP','FU','FU','FU'],
 'DPP(b12_2_8x2)_FU_FU':	 ['DPP','FU','FU'],
 'DPP(b12_2_8x2)_FU':	 ['DPP','FU'],
 'DPP(b12_2_8x2)_T_T_T':	 ['DPP','T','T','T'],
 'DPP(b12_2_8x2)_T_T':	 ['DPP','T','T'],
 'DPP(b12_2_8x2)_T':	 ['DPP','T'],
 'FL(a8x2)_BT':	 ['FL','BT'],
 'FU_DPP(a18x2)_FU_BTZ_b9_1_8':	 ['FU','DPP','FU','BTZ'],
 'FU_DPP(b12_2_8x2)_FU_BFF':	 ['FU','DPP','FU','BFF'],
 'FU_DPP(b12_2_8x2)_FU_TT':	 ['FU','DPP','FU','TT'],
 'FU_DPP(b12_2_8x2)_FU_TVT':	 ['FU','DPP','FU','TVT'],
 ...
 'NDI(b12_2_8x2)_FU_FU_FU':	 ['FU','NDI','FU','FU'],
 'NDI(b12_2_8x2)_FU_FU':	 ['FU','NDI','FU'],
 'NDI(b14_2_10x2)_TVT':	 ['NDI','TVT'],
 'NDI(b12_2_8x2)_T_BT_T':	['NDI','T','BT','T'],
 'NDI(b12_2_8x2)_T_BT_T':	 ['NDI','T','BT','T'],
 'NDI(b12_2_8x2)_T_T_T':	 ['T','NDI','T','T'],
 'NDI(b12_2_8x2)_T_T':	 ['T','NDI','T'],
 'NDI(b12_2_8x2)_T':	 ['NDI','T'],
 'NDTI(b12_2_8x2)_FU_FU_FU':	 ['FU','NDTI','FU','FU'],
 'NDTI(b12_2_8x2)_FU_FU':	 ['FU','NDTI','FU'],
 'NDTI(b12_2_8x2)_FU':	 ['NDTI','FU']
 'NDTI(b14_2_10x2)_BT':	 ['NDTI','BT'],
 'NDTI(b14_2_10x2)_T_T_T':	 ['NDTI', 'T', 'T', 'T'],
 'NDTI(b14_2_10x2)_T_T':	 ['NDTI','T','T'],
 'NDTI(b14_2_10x2)_T':	 ['NDTI', 'T'],
