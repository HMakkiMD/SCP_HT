...
gmx grompp -f minim.mdp -c AIG(b12_2_8x2)_T_10_1.gro -p AIG(b12_2_8x2)_T_10_1.top -o min.tpr

gmx mdrun -deffnm min -nt 24 -tableb table_corr_d1.xvg table_corr_d2.xvg table_corr_d3.xvg

gmx grompp -f npt.mdp -c min.gro -p AIG(b12_2_8x2)_T_10_1.top -o npt.tpr

gmx mdrun -deffnm npt  -nt 12 -tableb table_corr_d1.xvg table_corr_d2.xvg table_corr_d3.xvg

gmx grompp -f eq_soup.mdp -c npt.gro -p AIG(b12_2_8x2)_T_10_1.top -o 500/500.tpr
